...
echo "    /super-power:status     — lê CLAUDE.md + NOW.md e mostra estado do projeto"
echo "    /super-power:version    — mostra versão instalada + backups acumulados"
...
echo ""
echo "  Ou, em linguagem natural — basta falar com o Claude Code:"
echo "    \"Começa um projeto novo\"           → fluxo de pesquisa"
echo "    \"Atualiza o super power\"           → upgrade"
echo "    \"Desinstala o super power\"         → uninstall"
echo "    \"Limpa os backups\"                 → cleanup"
echo ""
echo -e "Documentação completa: ${B}https://github.com/johnnyhelder/claude-code-super-power${N}"
echo -e "Apoiar projecto (BTC):  ${Y}bc1q2n4p3zge5sj2pecjwxwmgape39taydjtq88cm9${N}"
echo ""
